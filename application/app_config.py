...
class LocationManagerConfig(config.Schema):
    def __init__(self):
        self.accuracy_threshold = config.Decimal("Accuracy Threshold (%)", default=10.0, min_val=0, max_val=100)
        self.distance_threshold = config.Decimal("Distance Threshold (m)", default=15.0, min_val=0)
